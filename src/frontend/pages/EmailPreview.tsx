  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Form */}
        <div className="card">
          <h2 className="text-lg font-bold text-slate-900 mb-4">Generate Preview</h2>
        ...
        {preview && (
          <div className="card">
            <h2 className="text-lg font-bold text-slate-900 mb-4">Email Preview</h2>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-slate-900 font-medium">{preview.subject}</p>
              </div>
